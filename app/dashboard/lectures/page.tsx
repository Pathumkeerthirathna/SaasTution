  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col py-2">
      <div className="rounded-3xl border border-black/10 bg-card p-6 shadow-sm dark:border-white/10 sm:p-8">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-muted">Lecture Management</p>
        <h1 className="mt-3 text-2xl font-semibold sm:text-3xl">Manage lectures, files, assignments, and quizzes</h1>
        <p className="mt-2 max-w-3xl text-sm text-muted sm:text-base">
          Create lectures with dates, upload notes and supporting materials, and add assignments and quizzes for each lecture.
        </p>
        <div className="mt-4">
          <Link
            href="/dashboard"
